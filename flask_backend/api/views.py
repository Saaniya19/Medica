...
def alternate(med):
  response = client.completions.create(model="MedicaAI",
  prompt="Q: Answer in one word; what is an alternate medication that can be taken as opposed to " + med + " and Ibuprofen? A: ",
  temperature=0,
  max_tokens=256,
  top_p=1,
  frequency_penalty=0,
