  ...
  return (
    <div className="flex flex-col items-center pb-9 bg-white">
      ...
      <div className="px-5 mt-24 ml-20 max-w-full w-[1069px] max-md:mt-10">
        <div className="flex gap-5 mt-12 max-md:flex-col max-md:gap-0 max-md:items-stretch">
        ...
        <Link to='/add-patient' className="items-center px-16 pt-4 pb-3.5 mt-28 max-w-full text-4xl font-semibold text-center text-white bg-blue-500 border-0 rounded-[30px] w-[416px] max-md:px-5 max-md:mt-10">
          Add a patient
        </Link>
      ...
      <div className="flex gap-5 justify-between items-start px-8 py-3.5 mt-14 max-w-full text-center max-md:flex-wrap max-md:px-5 max-md:mt-10">
        ...
        <div className="justify-center items-stretch pb-6">
          <button className="px-10 py-4 text-3xl font-semibold text-white whitespace-nowrap bg-blue-500 rounded-3xl max-md:px-5 mt-5">
            Search
          </button>
        </div>
      </div>
