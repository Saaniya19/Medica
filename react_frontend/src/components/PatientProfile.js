...
export const PatientProfile = ({name, dob, sex, email, address}) => {
    return (
        <div className="flex flex-col ml-5 w-[32%] max-md:ml-0 max-md:w-full">
            ...
            <div className="mt-9 text-5xl font-semibold text-center text-black max-md:text-4xl">{name}</div>
            ...
            <div className="self-stretch max-md:max-w-full">
                ...
                <div className="flex flex-col ml-5 w-[71%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col grow text-2xl text-center whitespace-nowrap text-neutral-500 max-md:mt-10">
                        <div style={{position:'text-right'}} className="self-end mt-16 max-md:mt-10">{dob}</div>
                        <div style={{position:'text-right'}} className="self-end mt-16 max-md:mt-10">{sex}</div>
                        <div style={{position:'text-right'}} className="self-end mt-16 max-md:mt-10">{email}</div>
                        <div style={{position:'text-right'}} className="self-end mt-16 max-md:mt-10">{address}</div>
                    </div>
                </div>
                </div>
            </div>
